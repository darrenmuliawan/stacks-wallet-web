...
import { buildConfirmationDialogMessage } from "../utils/utils";
...
export const getDataSourcesListState = () => {
  ...
  const toggleFacebookConnection = () => {
    ...
    if (checked) {
      ...
      setConfirmationDialogMessage(buildConfirmationDialogMessage(facebookConnection.name))
    }
  }
  ...
  const toggleTwitterConnection = () => {
    ...
    if (checked) {
      ...
      setConfirmationDialogMessage(buildConfirmationDialogMessage(twitterConnection.name))
    }
  }
  const twitter = {
  ...
  const toggleGoogleConnection = () => {
    ...
    if (checked) {
      ...
      setConfirmationDialogMessage(buildConfirmationDialogMessage(googleConnection.name))
    }
  }
  const google = {
  ...
  const toggleInstagramConnection = () => {
    ...
    if (checked) {
      ...
      setConfirmationDialogMessage(buildConfirmationDialogMessage(instagramConnection.name))
    }
  }
  const instagram = {
  ...
  const toggleLinkedinConnection = () => {
    ...
    if (checked) {
      ...
      setConfirmationDialogMessage(buildConfirmationDialogMessage(linkedinConnection.name))
    }
  }
  const linkedin = {
  ...
  const toggleRedditConnection = () => {
    ...
    if (checked) {
      ...
      setConfirmationDialogMessage(buildConfirmationDialogMessage(redditConnection.name))
    }
  }
  const reddit = {
  ...
  const toggleTiktokConnection = () => {
    ...
    if (checked) {
      ...
      setConfirmationDialogMessage(buildConfirmationDialogMessage(tiktokConnection.name))
    }
  }
  const tiktok = {
  ...
  const toggleAppleConnection = () => {
    ...
    if (checked) {
      ...
      setConfirmationDialogMessage(buildConfirmationDialogMessage(appleConnection.name))
    }
  }
  const apple = {
  ...
  const toggleAmazonConnection = () => {
    ...
    if (checked) {
      ...
      setConfirmationDialogMessage(buildConfirmationDialogMessage(amazonConnection.name))
    }
  }
  const amazon = {
  ...
  const toggleSnapchatConnection = () => {
    ...
    if (checked) {
      ...
      setConfirmationDialogMessage(buildConfirmationDialogMessage(snapchatConnection.name))
    }
  }
  const snapchat = {
