...
import { Box, DynamicColorCircle, Stack, Text, Button, color } from "@stacks/ui"
...
import { DataVaultActions } from "../data-vault/components/data-vault-actions";
import { useCurrentPageState } from "../data-vault/hooks/data-vault.hooks";
import { DATA_VAULT_PAGE_ENUM } from "../data-vault/store/data-vault.store";
      ...
      <Stack pt="tight" flexGrow={1} width="100%" isInline spacing="base" alignItems="center">
        ...
        <Stack flexGrow={1}>
          ...
          <Caption
            ...
            // color={color('brand')}
            onClick={() => navigate(RouteUrls.FacebookData)}
          >
            View & Manage Data
          </Caption>
        </Stack>
